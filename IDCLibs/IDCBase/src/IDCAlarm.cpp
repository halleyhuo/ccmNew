...
CIdcAlarm::CIdcAlarm()
{
	...
	//Init array
	for (short m_iNr = 0; m_iNr < MAX_DELAYED_MESSAGES; m_iNr++) {
...
bool CIdcAlarm::CreateAlarm( ushort elapseMs,
...
bool CIdcAlarm::DeleteAlarm( ulong id )
{
	short   m_iNr;
